...
namespace Bl.Migrations
{
    ...
    [Migration("20240921215644_EditShowinHomCategory")]
    partial class EditShowinHomCategory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bl.Classes.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Domains.SpResult.Sp_GetFillteredItems_Result", b =>
                {
                    ...
                    b.ToTable("FilteredItems_Result", (string)null);
                });

            modelBuilder.Entity("Domains.SpResult.Sp_GetHomePageData_Result", b =>
                {
                    b.Property<int>("ItemId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("sp_GetHomePageData", (string)null);
                });

            modelBuilder.Entity("Domains.Tables.TbBusinessInfo", b =>
                {
            ...
            modelBuilder.Entity("Domains.Tables.TbCashTransacion", b =>
                {
            ...
            modelBuilder.Entity("Domains.Tables.TbCategory", b =>
                {
                    b.Property<int>("CategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domains.Tables.TbCustomer", b =>
                {
                    b.Property<int>("CustomerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domains.Tables.TbItem", b =>
                {
                    b.Property<int>("ItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domains.Tables.TbItemDiscount", b =>
                {
            ...
            modelBuilder.Entity("Domains.Tables.TbItemImage", b =>
                {
            ...
            modelBuilder.Entity("Domains.Tables.TbItemType", b =>
                {
                    b.Property<int>("ItemTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domains.Tables.TbO", b =>
                {
                    b.Property<int>("OsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domains.Tables.TbPage", b =>
                {
            ...
            modelBuilder.Entity("Domains.Tables.TbPurchaseInvoice", b =>
                {
            ...
            modelBuilder.Entity("Domains.Tables.TbPurchaseInvoiceItem", b =>
                {
            ...
            modelBuilder.Entity("Domains.Tables.TbSalesInvoice", b =>
                {
                    b.Property<int>("InvoiceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domains.Tables.TbSalesInvoiceItem", b =>
                {
                    b.Property<int>("InvoiceItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domains.Tables.TbSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domains.Tables.TbSlider", b =>
                {
            ...
            modelBuilder.Entity("Domains.Tables.TbSupplier", b =>
                {
                    b.Property<int>("SupplierId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domains.ViewResult.VwItem", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domains.ViewResult.VwItemCategory", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domains.ViewResult.VwItemCategory1", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domains.ViewResult.VwItemsOutOfInvoice", b =>
                {
                    b.Property<string>("CategoryName")
                        .IsRequired()
                        .HasMaxLength(100)
            ...
            modelBuilder.Entity("Domains.ViewResult.VwSalesInvoice", b =>
                {
                    b.Property<string>("CreatedBy")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("TbCustomerItem", b =>
                {
                    ...
                    b.ToTable("TbCustomerItem");
                });

            modelBuilder.Entity("Domains.Tables.TbBusinessInfo", b =>
                {
                    b.HasOne("Domains.Tables.TbCustomer", "Cutomer")
                        .WithOne("TbBusinessInfo")
                        .HasForeignKey("Domains.Tables.TbBusinessInfo", "CutomerId")
            ...
            modelBuilder.Entity("Domains.Tables.TbItem", b =>
                {
                    b.HasOne("Domains.Tables.TbCategory", "Category")
                        .WithMany("TbItems")
                        .HasForeignKey("CategoryId")
                        .IsRequired()
                        .HasConstraintName("FK_TbItems_TbCategories");

                    b.HasOne("Domains.Tables.TbItemType", "ItemType")
                        .WithMany("TbItems")
                    ...
                    b.HasOne("Domains.Tables.TbO", "Os")
                        .WithMany("TbItems")
                        .HasForeignKey("OsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("Domains.Tables.TbItemDiscount", b =>
                {
                    b.HasOne("Domains.Tables.TbItem", "Item")
            ...
            modelBuilder.Entity("Domains.Tables.TbPurchaseInvoice", b =>
                {
                    b.HasOne("Domains.Tables.TbSupplier", "Supplier")
            ...
            modelBuilder.Entity("Domains.Tables.TbPurchaseInvoiceItem", b =>
                {
                    b.HasOne("Domains.Tables.TbPurchaseInvoice", "Invoice")
            ...
            modelBuilder.Entity("Domains.Tables.TbSalesInvoiceItem", b =>
                {
                    b.HasOne("Domains.Tables.TbSalesInvoice", "Invoice")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Bl.Classes.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TbCustomerItem", b =>
                {
                    b.HasOne("Domains.Tables.TbCustomer", null)
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domains.Tables.TbItem", null)
                        .WithMany()
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
